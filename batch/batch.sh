...
python train_model.py --model 'lfads-gaussian' --data_suffix fluor --data_path $SLURM_TMPDIR/allen_m1s1_soma_ou_t0.3_s2.0_f_z_n --hyperparameter_path /home/mila/b/bakhtias/Project-Codes/calfads/hyperparameters/lorenz/lfads-gaussian.yaml --output_dir /network/tmp1/bakhtias/Results/LFADS/ --batch_size 100 --max_epochs 1000
