...
class SVLAE_Net(nn.Module):
    ...
    def __init__(self, input_size,
                 ...
                 obs_params=PARAMS, clip_val=5.0, dropout=0.0, 
                 max_norm=200, generator_burn=0, deep_unfreeze_step=2000, 
                 obs_pad=3, do_normalize_factors=True, factor_bias=False, 
                 device='cpu'):
        ...
        self.deep_model = lfads.LFADS_Net(
            input_size      = self.obs_encoder_size*2,
